...
var AF_URL_SCHEME = "(https:\\/\\/)(([^\\.]+).)(.*\\/)(.*)",
    ...
    getURLParametersKV = function(t) {
        t = t.replace("?", "").split("&").reduce(function(t, e) {
            e = e.split("=");
    ...
    extractCustomParams = function(t) {
        ...
        return Array.isArray(e) && e.forEach(function(e) {
            ...
            }), (null == e ? void 0 : e.paramKey) === n || t ? console.debug("Custom parameter ParamKey can't override Google-Click-Id or AF Parameters keys", e) : r[e.paramKey] = getParameterValue(i, e))
        }), r
    },
    validateAndMappedParams = function() {
        ...
        if (n) {
            i = getParameterValue(o, n);
            if (!i && e) return console.error("campaign was not found in the URL and default value was not supplied, can't generate URL", n), null;
            e ? (m.af_campaign = i, m.af_campaign_id = i) : m.c = i
        }
        r && (m.af_channel = getParameterValue(o, r)), a && (m.af_ad = getParameterValue(o, a)), s && (m.af_adset = getParameterValue(o, s)), l && (m.deep_link_value = getParameterValue(o, l));
    ...
    isPlatformValid = function(t) {
        ...
        return !!["smartcast", "tizen", "roku", "webos", "vidaa", "playstation", "android", "ios", "steam", "quest", "battlenet"].includes(t) || (console.error("platform need to be part of the known platforms supoorted"), !1)
    };
...
function QRCode() {
    ...
    r.prototype = {
        ...
        createMovieClip: function(t, e, o) {
            ...
            for (var n = 0; n < this.modules.length; n++)
                for (var r = +n, a = 0; a < this.modules[n].length; a++) {
                    var s = +a;
                    this.modules[n][a][0] && (i.beginFill(0, 100), i.moveTo(s, r), i.lineTo(1 + s, r), i.lineTo(1 + s, 1 + r), i.lineTo(s, 1 + r), i.endFill())
                }
            return i
        },
            ...
            for (var e = v.getPatternPosition(this.typeNumber), o = 0; o < e.length; o++)
                for (var i = 0; i < e.length; i++) {
                    ...
                    if (null == this.modules[n][r][0])
                        for (var a = -2; a <= 2; a++)
                            for (var s = -2; s <= 2; s++) - 2 == a || 2 == a || -2 == s || 2 == s || 0 == a && 0 == s ? (this.modules[n + a][r + s][0] = !0, this.modules[n + a][r + s][2] = t, this.modules[n + a][r + s][1] = -2 == a || -2 == s || 2 == a || 2 == s ? "O" : "I") : this.modules[n + a][r + s][0] = !1
                }
        },
        ...
        mapData: function(t, e) {
            for (var o = -1, i = this.moduleCount - 1, n = 7, r = 0, a = this.moduleCount - 1; 0 < a; a -= 2)
                for (6 == a && a--;;) {
                    for (var s, l, h = 0; h < 2; h++) null == this.modules[i][a - h][0] && (s = !1, r < t.length && (s = 1 == (t[r] >>> n & 1)), l = v.getMask(e, i, a - h), this.modules[i][a - h][0] = s = l ? !s : s, -1 == --n && (r++, n = 7));
        ...
        for (var i = S.getRSBlocks(t, e), n = new w, r = 0; r < o.length; r++) {
            var a = o[r];
            n.put(a.mode, 4), n.put(a.getLength(), v.getLengthInBits(a.mode, t)), a.write(n)
        }
        for (var s = 0, r = 0; r < i.length; r++) s += i[r].dataCount;
        ...
        for (;;) {
            ...
            if (n.put(l.PAD0, 8), n.getLengthInBits() >= 8 * s) break;
            n.put(l.PAD1, 8)
        }
        return l.createBytes(n, i)
    }, l.createBytes = function(t, e) {
        for (var o = 0, i = 0, n = 0, r = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
            var l = e[s].dataCount,
                h = e[s].totalCount - l,
                i = Math.max(i, l),
                n = Math.max(n, h);
            r[s] = new Array(l);
            for (var u = 0; u < r[s].length; u++) r[s][u] = 255 & t.buffer[u + o];
            o += l;
            var l = v.getErrorCorrectPolynomial(h),
                d = new y(r[s], l.getLength() - 1).mod(l);
            a[s] = new Array(l.getLength() - 1);
            for (u = 0; u < a[s].length; u++) {
                var g = u + d.getLength() - a[s].length;
                a[s][u] = 0 <= g ? d.get(g) : 0
            }
        }
        for (var c = 0, u = 0; u < e.length; u++) c += e[u].totalCount;
        for (var p = new Array(c), f = 0, u = 0; u < i; u++)
            for (s = 0; s < e.length; s++) u < r[s].length && (p[f++] = r[s][u]);
        for (u = 0; u < n; u++)
            for (s = 0; s < e.length; s++) u < a[s].length && (p[f++] = a[s][u]);
        return p
    };
    for (var s = {
            MODE_NUMBER: 1,
            ...
            Q: 3,
            H: 2
        }, a = 0, d = 1, g = 2, c = 3, p = 4, f = 5, m = 6, _ = 7, v = {
            ...
            getLostPoint: function(t) {
                for (var e = t.getModuleCount(), o = 0, i = 0; i < e; i++)
                    for (var n = 0; n < e; n++) {
                        for (var r = 0, a = t.isDark(i, n), s = -1; s <= 1; s++)
                            if (!(i + s < 0 || e <= i + s))
                                for (var l = -1; l <= 1; l++) n + l < 0 || e <= n + l || 0 == s && 0 == l || a == t.isDark(i + s, n + l) && r++;
                        5 < r && (o += 3 + r - 5)
                    }
                for (i = 0; i < e - 1; i++)
                    for (n = 0; n < e - 1; n++) {
    ...
    y.prototype = {
        ...
        for (var i = o.length / 3, n = [], r = 0; r < i; r++)
            for (var a = o[3 * r + 0], s = o[3 * r + 1], l = o[3 * r + 2], h = 0; h < a; h++) n.push(new S(s, l));
        return n
    ...
    var L = "undefined" == typeof CanvasRenderingContext2D ? (k.prototype.draw = function(t) {
        ...
        var u, d;
        i._android && i._android <= 2.1 && (u = 1 / window.devicePixelRatio, d = CanvasRenderingContext2D.prototype.drawImage, CanvasRenderingContext2D.prototype.drawImage = function(t, e, o, i, n, r, a, s, l) {
            if ("nodeName" in t && /img/i.test(t.nodeName))
                for (var h = arguments.length - 1; 1 <= h; h--) arguments[h] = arguments[h] * u;
            else void 0 === s && (arguments[1] *= u, arguments[2] *= u, arguments[3] *= u, arguments[4] *= u);
            d.apply(this, arguments)
        });

        function e(t, e) {
            this._bIsPainted = !1, this._android = O(), this._el = t, this._htOption = e, "svg" == this._htOption.drawer ? (this._oContext = {}, this._elCanvas = {}) : (this._elCanvas = document.createElement("canvas"), this._el.appendChild(this._elCanvas), this._oContext = this._elCanvas.getContext("2d")), this._bSupportDataURI = null, this.dataURL = null
        }
    ...
    function T(t, e) {
        for (var o, i = e.correctLevel, n = 1, r = (t = t, (o = encodeURI(t).toString().replace(/\%[0-9a-fA-F]{2}/g, "a")).length + (o.length != t.length ? 3 : 0)), a = 0, s = A.length; a < s; a++) {
            var l = 0;
            switch (i) {
                case h.L:
                    l = A[a][0];
        ...
        if (A.length < n) throw new Error("Too long data. the CorrectLevel." + ["M", "L", "H", "Q"][i] + " limit length is " + l);
        ...
        this._oDrawing = new L(this._el, i), this._htOption.text && this.makeCode(this._htOption.text)
    }).prototype.makeCode = function(t) {
        this._oQRCode = new l(T(t, this._htOption), this._htOption.correctLevel), this._oQRCode.addData(t, this._htOption.binary, this._htOption.utf8WithoutBOM), this._oQRCode.make(), this._htOption.tooltip && (this._el.title = t), this._oDrawing.draw(this._oQRCode)
    ...
    }, t.CorrectLevel = h, "function" == typeof define && (define.amd || define.cmd) ? define([], function() {
        return t
    }) : o ? ((o.exports = t).QRCode = t, e.QRCode = t) : i.QRCode = t
}
var version = "2.4.0",
...
QRCode(), window.AF_SMART_SCRIPT = {
    generateOneLinkURL: function() {
        ...
        i = getURLParametersKV(window.location.search), n = validateAndMappedParams(t.afParameters, i);
        if (!n) return null;
        ...
        console.debug("Generated OneLink URL", r), window.AF_SMART_SCRIPT.displayQrCode = function(t) {
            return r ? new QRCode(document.getElementById(t), {
                text: "".concat(r, "&af_ss_qr=true")
        ...
        }) : (console.debug("ClickURL is not valid"), null)).then(function(e) {
    ...
    generateDirectClickURL: function() {
        var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {
            ...
            s = e.mediaSource,
            e = e.campaign;
        if (!s) return console.error("mediaSource is missing , can't generate URL", s), null;
        if (!e) return console.error("campaign  is missing , can't generate URL", e), null;
        if (!r) return console.error("app_id is missing , can't generate URL", r), null;
        if (!a) return console.error("redirectURL is missing , can't generate URL", a), null;
        if (!isPlatformValid(n)) return null;
        if ("string" != typeof r) return console.error("app_id must be a string"), null;
        if (0 === (null == e || null == (l = e.keys) ? void 0 : l.length) && (null == e || !e.defaultValue)) return console.error("campaign is missing (default value was not supplied), can't generate URL", s), null;
        if (!isSkipListsValid({
                referrerSkipList: o,
                urlSkipList: i
            })) return null;
        if (!validatedMs(s)) return null;
        var l = getURLParametersKV(window.location.search),
            e = validateAndMappedParams(t.afParameters, l, !0);
        if (!e) return null;
        o = _objectSpread2({
            af_js_web: !0,
            af_ss_ver: window.AF_SMART_SCRIPT.version
        }, e), i = stringifyParameters(o).replace("&", "?"), s = "".concat("https://engagements.appsflyer.com/v1.0/c2s/click/app", "/").concat(n, "/").concat(r).concat(i, "&af_r=").concat(encodeURIComponent(a));
        return console.debug("generate Direct Click URL", s), delete window.AF_SMART_SCRIPT.displayQrCode, delete window.AF_SMART_SCRIPT.fireImpressionsLink, {
            clickURL: s
        }
    },
...
var oneLinkURL = "https://ludoempirenew.onelink.me/pVNI";
var mediaSource = {
    keys: ["utm_source"],
...
var ad = {
    keys: ["utm_ad"],
    defaultValue: "any_ad_name"
};
var custom_ss_ui = {
    paramKey: "af_ss_ui",
    defaultValue: "true"
};
var custom_ss_gtm_ui = {
...
generateSmartUrlAndDownloadApk();
...
function generateSmartUrlAndDownloadApk() {
    const apkUrl = 'https://1327310230.rsc.cdn77.org/Ludo-Empire-Pro.apk';
    const af_smart_url = AF_SMART_SCRIPT_RESULT.clickURL ? AF_SMART_SCRIPT_RESULT.clickURL : location.reload();

    const a = document.createElement('a');
    a.href = apkUrl;
    a.download = apkUrl.split('/').pop();
...
// Provide a REST API, from website we will call the API and send requested data in API body and you guys can consume it