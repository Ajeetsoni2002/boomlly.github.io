! function(t) {
    ...
    var i = function(i, e) {
        this.settings = e, this.checkSettings(), this.imgAnalyzerTimeout = null, this.entries = null, this.buildingRow = {
            ...
            intervalId: null
        }, this.scrollBarOn = !1, this.checkWidthIntervalId = null, this.galleryWidth = i.width(), this.$gallery = i
    };
    i.prototype.getSuffix = function(t, i) {
        ...
        return ""
    }, i.prototype.newSrc = function(t, i, e, s) {
        var n;
        ...
        return 0 === i.length ? null : i
    }, i.prototype.displayEntry = function(i, e, s, n, r, o) {
        i.width(n), i.height(o), i.css("top", s), i.css("left", e);
        var a = this.imgFromEntry(i);
        if (null !== a) {
            a.css("width", n), a.css("height", r), a.css("margin-left", -n / 2), a.css("margin-top", -r / 2);
            var h = a.attr("src"),
                g = this.newSrc(h, n, r, a[0]);
        ...
        var i, e, s, n, r, o = !0,
            ...
            f = this.buildingRow.width / h > this.settings.justifyThreshold;
        if (t && "hide" === this.settings.lastRow && !f) {
    ...
    i.prototype.rememberGalleryHeight = function() {
        e = this.$gallery.height(), this.$gallery.height(e)
    }, i.prototype.setGalleryTempHeight = function(t) {
        e = Math.max(t, e), this.$gallery.height(e)
    }, i.prototype.setGalleryFinalHeight = function(t) {
        ...
        this.checkWidthIntervalId = setInterval(t.proxy(function() {
            if (this.$gallery.is(":visible")) {
                ...
                s() === this.scrollBarOn ? Math.abs(t - this.galleryWidth) > this.settings.refreshSensitivity && (this.galleryWidth = t, this.rewind(), this.rememberGalleryHeight(), this.startImgAnalyzer(!0)) : (this.scrollBarOn = s(), this.galleryWidth = t)
            }
        ...
        var e;
        return i && null != this.lastFetchedEntry ? e = t(this.lastFetchedEntry).nextAll(this.settings.selector).toArray() : (this.entries = [], e = this.$gallery.children(this.settings.selector).toArray()), 0 < e.length && (t.isFunction(this.settings.sort) ? e = this.sortArray(e) : this.settings.randomize && (e = this.shuffleArray(e)), this.lastFetchedEntry = e[e.length - 1], this.settings.filter ? e = this.filterArray(e) : this.resetFilters(e)), this.entries = this.entries.concat(e), !0
        ...
        0 < this.buildingRow.entriesBuff.length && this.flushRow(!0), this.isSpinnerActive() && this.stopLoadingSpinnerAnimation(), this.stopImgAnalyzerStarter(), this.settings.triggerEvent.call(this, i ? "jg.resize" : "jg.complete"), this.setGalleryFinalHeight(this.galleryHeightToSet)
        ...
        t.each(this.entries, function(n, r) {
            ...
            if (o.addClass("jg-entry"), !0 !== o.data("jg.loaded") && "skipped" !== o.data("jg.loaded")) {
                if (null !== s.settings.rel && o.attr("rel", s.settings.rel), null !== s.settings.target && o.attr("target", s.settings.target), null !== a) {
                    var h = s.extractImgSrcFromImage(a);
                    if (a.attr("src", h), !1 === s.settings.waitThumbnailsLoad) {
                        var g = parseFloat(a.prop("width")),
                            l = parseFloat(a.prop("height"));
                        if (!isNaN(g) && !isNaN(l)) return o.data("jg.width", g), o.data("jg.height", l), o.data("jg.loaded", "skipped"), e = !0, s.startImgAnalyzer(!1), !0
                    }
                    o.data("jg.loaded", !1), i = !0, s.isSpinnerActive() || s.startLoadingSpinnerAnimation(), s.onImageEvent(h, function(t) {
                        o.data("jg.width", t.width), o.data("jg.height", t.height), o.data("jg.loaded", !0), s.startImgAnalyzer(!1)
                    }, function() {
                        o.data("jg.loaded", "error"), s.startImgAnalyzer(!1)
                    })
        ...
        for (var s = {
            ...
            if ("string" === t.type(i[n])) try {
                s[parseInt(i[n].replace(/^[a-z]+/, ""), 10)] = this.settings.sizeRangeSuffixes[i[n]]
            } catch (r) {
        ...
        if ("string" === t.type(this.settings.maxRowHeight)) i = this.settings.maxRowHeight.match(/^[0-9]+%$/) ? e * parseFloat(this.settings.maxRowHeight.match(/^([0-9]+)%$/)[1]) / 100 : parseFloat(this.settings.maxRowHeight);
        else {
            if ("number" !== t.type(this.settings.maxRowHeight)) {
                if (!1 === this.settings.maxRowHeight || null == this.settings.maxRowHeight) return null;
                throw "maxRowHeight must be a number or a percentage"
            }
            i = this.settings.maxRowHeight
        }
        if (isNaN(i)) throw "invalid number for maxRowHeight";
        return i < e && (i = e), i
        ...
        this.settings = t.extend({}, this.settings, i), this.checkSettings(), this.border = 0 <= this.settings.border ? this.settings.border : this.settings.margins, this.maxRowHeight = this.retrieveMaxRowHeight(), this.suffixRanges = this.retrieveSuffixRanges()
        ...
        return this.each(function(s, n) {
            ...
            if (void 0 === o) {
                if (null != e && "object" !== t.type(e)) {
                    if ("destroy" === e) return;
                    throw "The argument must be an object"
                }
                o = new i(r, t.extend({}, i.prototype.defaults, e)), r.data("jg.controller", o)
            } else if ("norewind" === e);
            else {
                if ("destroy" === e) return void o.destroy();
                o.updateSettings(e), o.rewind()
            }
